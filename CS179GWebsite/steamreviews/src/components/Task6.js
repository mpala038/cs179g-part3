  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(`http://localhost:5000/task6?page=${page}&appName=${appName}`);
        console.log(`Fetching data from: http://localhost:5000/task6?page=${page}&appName=${appName}`); // Log the URL
